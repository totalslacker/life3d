...
struct ColorTheme: Sendable, Identifiable, Hashable {
    ...
    static let palladium = ColorTheme(
        name: "Palladium",
        newborn: TierColors(
            baseColor: SIMD4(0.88, 0.90, 0.92, 1.0),
            emissiveColor: SIMD3(0.88, 0.90, 0.92),
            emissiveIntensity: 2.1, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.68, 0.70, 0.74, 1.0),
            emissiveColor: SIMD3(0.60, 0.62, 0.68),
            emissiveIntensity: 1.1, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.46, 0.48, 0.53, 1.0),
            emissiveColor: SIMD3(0.36, 0.38, 0.44),
            emissiveIntensity: 0.40, opacity: 0.18),
        dying: TierColors(
            baseColor: SIMD4(0.22, 0.23, 0.26, 1.0),
            emissiveColor: SIMD3(0.12, 0.12, 0.15),
            emissiveIntensity: 0.08, opacity: 0.03)
    )

    static let allThemes: [ColorTheme] = [.neon, .warmAmber, .oceanBlues, .aurora, .monochrome, .infrared, .bioluminescence, .sakura, .ember, .nebula, .glacier, .coral, .forest, .sunset, .twilight, .jade, .crimson, .amethyst, .copper, .gold, .midnight, .volcanic, .plasma, .frost, .arctic, .solar, .toxic, .starfield, .hologram, .cyberpunk, .vaporwave, .synthwave, .terracotta, .lavender, .matrix, .champagne, .opal, .roseGold, .peridot, .sapphire, .obsidian, .ruby, .titanium, .garnet, .emerald, .tungsten, .aquamarine, .bronze, .ivory, .pearl, .graphite, .slate, .cobalt, .vermilion, .indigo, .mahogany, .burgundy, .teal, .chartreuse, .saffron, .moss, .cerulean, .mauve, .marigold, .sage, .ochre, .umber, .sienna, .viridian, .pewter, .celadon, .turquoise, .denim, .palladium]
}
