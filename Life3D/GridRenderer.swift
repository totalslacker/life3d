...
struct ColorTheme: Sendable, Identifiable, Hashable {
    ...
    static let spinel = ColorTheme(
        name: "Spinel",
        newborn: TierColors(
            baseColor: SIMD4(0.90, 0.18, 0.35, 1.0),
            emissiveColor: SIMD3(0.88, 0.15, 0.32),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.62, 0.12, 0.25, 1.0),
            emissiveColor: SIMD3(0.58, 0.10, 0.22),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.35, 0.06, 0.14, 1.0),
            emissiveColor: SIMD3(0.30, 0.05, 0.12),
            emissiveIntensity: 0.8, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.16, 0.03, 0.07, 1.0),
            emissiveColor: SIMD3(0.12, 0.02, 0.05),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let hematite = ColorTheme(
        name: "Hematite",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.70, 0.74, 1.0),
            emissiveColor: SIMD3(0.72, 0.70, 0.74),
            emissiveIntensity: 2.1, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.48, 0.45, 0.50, 1.0),
            emissiveColor: SIMD3(0.42, 0.40, 0.45),
            emissiveIntensity: 1.1, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.28, 0.26, 0.30, 1.0),
            emissiveColor: SIMD3(0.22, 0.20, 0.25),
            emissiveIntensity: 0.40, opacity: 0.18),
        dying: TierColors(
            baseColor: SIMD4(0.12, 0.11, 0.14, 1.0),
            emissiveColor: SIMD3(0.08, 0.07, 0.09),
            emissiveIntensity: 0.08, opacity: 0.03)
    )

    static let chrysocolla = ColorTheme(
        name: "Chrysocolla",
        newborn: TierColors(
            baseColor: SIMD4(0.18, 0.82, 0.78, 1.0),
            emissiveColor: SIMD3(0.15, 0.78, 0.74),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.12, 0.56, 0.58, 1.0),
            emissiveColor: SIMD3(0.10, 0.52, 0.54),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.06, 0.32, 0.38, 1.0),
            emissiveColor: SIMD3(0.05, 0.28, 0.34),
            emissiveIntensity: 0.8, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.02, 0.14, 0.18, 1.0),
            emissiveColor: SIMD3(0.02, 0.10, 0.14),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let moonstone = ColorTheme(
        name: "Moonstone",
        newborn: TierColors(
            baseColor: SIMD4(0.82, 0.85, 0.95, 1.0),
            emissiveColor: SIMD3(0.78, 0.82, 0.92),
            emissiveIntensity: 2.2, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.55, 0.60, 0.72, 1.0),
            emissiveColor: SIMD3(0.50, 0.55, 0.68),
            emissiveIntensity: 1.3, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.32, 0.36, 0.48, 1.0),
            emissiveColor: SIMD3(0.28, 0.32, 0.44),
            emissiveIntensity: 0.8, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.14, 0.16, 0.22, 1.0),
            emissiveColor: SIMD3(0.10, 0.12, 0.18),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let chalcedony = ColorTheme(
        name: "Chalcedony",
        newborn: TierColors(
            baseColor: SIMD4(0.68, 0.76, 0.85, 1.0),
            emissiveColor: SIMD3(0.65, 0.73, 0.82),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.48, 0.55, 0.65, 1.0),
            emissiveColor: SIMD3(0.44, 0.50, 0.60),
            emissiveIntensity: 1.1, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.30, 0.35, 0.44, 1.0),
            emissiveColor: SIMD3(0.25, 0.30, 0.38),
            emissiveIntensity: 0.45, opacity: 0.18),
        dying: TierColors(
            baseColor: SIMD4(0.14, 0.16, 0.22, 1.0),
            emissiveColor: SIMD3(0.10, 0.12, 0.16),
            emissiveIntensity: 0.08, opacity: 0.03)
    )

    static let beryl = ColorTheme(
        name: "Beryl",
        newborn: TierColors(
            baseColor: SIMD4(0.55, 0.88, 0.72, 1.0),
            emissiveColor: SIMD3(0.50, 0.85, 0.68),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.35, 0.65, 0.52, 1.0),
            emissiveColor: SIMD3(0.30, 0.60, 0.48),
            emissiveIntensity: 1.1, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.18, 0.42, 0.34, 1.0),
            emissiveColor: SIMD3(0.15, 0.38, 0.30),
            emissiveIntensity: 0.45, opacity: 0.18),
        dying: TierColors(
            baseColor: SIMD4(0.08, 0.20, 0.16, 1.0),
            emissiveColor: SIMD3(0.06, 0.15, 0.12),
            emissiveIntensity: 0.08, opacity: 0.03)
    )

    static let azurite = ColorTheme(
        name: "Azurite",
        newborn: TierColors(
            baseColor: SIMD4(0.08, 0.30, 0.92, 1.0),
            emissiveColor: SIMD3(0.06, 0.26, 0.88),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.05, 0.20, 0.65, 1.0),
            emissiveColor: SIMD3(0.04, 0.18, 0.60),
            emissiveIntensity: 1.1, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.03, 0.12, 0.38, 1.0),
            emissiveColor: SIMD3(0.02, 0.10, 0.34),
            emissiveIntensity: 0.45, opacity: 0.20),
        dying: TierColors(
            baseColor: SIMD4(0.01, 0.05, 0.18, 1.0),
            emissiveColor: SIMD3(0.01, 0.04, 0.14),
            emissiveIntensity: 0.10, opacity: 0.05)
    )

    static let kyanite = ColorTheme(
        name: "Kyanite",
        newborn: TierColors(
            baseColor: SIMD4(0.38, 0.52, 0.82, 1.0),
            emissiveColor: SIMD3(0.34, 0.48, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.25, 0.38, 0.62, 1.0),
            emissiveColor: SIMD3(0.22, 0.34, 0.58),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.15, 0.22, 0.42, 1.0),
            emissiveColor: SIMD3(0.12, 0.18, 0.38),
            emissiveIntensity: 0.8, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.08, 0.12, 0.22, 1.0),
            emissiveColor: SIMD3(0.05, 0.08, 0.18),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let agate = ColorTheme(
        name: "Agate",
        newborn: TierColors(
            baseColor: SIMD4(0.88, 0.62, 0.35, 1.0),
            emissiveColor: SIMD3(0.85, 0.58, 0.30),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.65, 0.40, 0.22, 1.0),
            emissiveColor: SIMD3(0.60, 0.36, 0.18),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.40, 0.24, 0.12, 1.0),
            emissiveColor: SIMD3(0.36, 0.20, 0.10),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.18, 0.10, 0.05, 1.0),
            emissiveColor: SIMD3(0.14, 0.08, 0.04),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let ammolite = ColorTheme(
        name: "Ammolite",
        newborn: TierColors(
            baseColor: SIMD4(0.90, 0.42, 0.18, 1.0),
            emissiveColor: SIMD3(0.88, 0.38, 0.15),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.22, 0.72, 0.38, 1.0),
            emissiveColor: SIMD3(0.18, 0.68, 0.34),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.15, 0.28, 0.65, 1.0),
            emissiveColor: SIMD3(0.12, 0.24, 0.60),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.08, 0.12, 0.28, 1.0),
            emissiveColor: SIMD3(0.06, 0.10, 0.24),
            emissiveIntensity: 0.4, opacity: 0.10)
    )
    ...
    static let pyrite = ColorTheme(
        name: "Pyrite",
        newborn: TierColors(
            baseColor: SIMD4(0.90, 0.82, 0.42, 1.0),
            emissiveColor: SIMD3(0.88, 0.78, 0.38),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.72, 0.62, 0.28, 1.0),
            emissiveColor: SIMD3(0.68, 0.58, 0.24),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.48, 0.40, 0.15, 1.0),
            emissiveColor: SIMD3(0.44, 0.36, 0.12),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.24, 0.20, 0.08, 1.0),
            emissiveColor: SIMD3(0.20, 0.16, 0.06),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let chrysoprase = ColorTheme(
        name: "Chrysoprase",
        newborn: TierColors(
            baseColor: SIMD4(0.48, 0.88, 0.42, 1.0),
            emissiveColor: SIMD3(0.44, 0.85, 0.38),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.28, 0.68, 0.32, 1.0),
            emissiveColor: SIMD3(0.24, 0.64, 0.28),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.12, 0.42, 0.18, 1.0),
            emissiveColor: SIMD3(0.10, 0.38, 0.15),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.05, 0.18, 0.08, 1.0),
            emissiveColor: SIMD3(0.04, 0.15, 0.06),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let charoite = ColorTheme(
        name: "Charoite",
        newborn: TierColors(
            baseColor: SIMD4(0.62, 0.28, 0.82, 1.0),
            emissiveColor: SIMD3(0.58, 0.24, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.42, 0.18, 0.62, 1.0),
            emissiveColor: SIMD3(0.38, 0.15, 0.58),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.25, 0.10, 0.38, 1.0),
            emissiveColor: SIMD3(0.22, 0.08, 0.35),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.12, 0.05, 0.18, 1.0),
            emissiveColor: SIMD3(0.10, 0.04, 0.15),
            emissiveIntensity: 0.4, opacity: 0.10)
    )


    static let iolite = ColorTheme(
        name: "Iolite",
        newborn: TierColors(
            baseColor: SIMD4(0.42, 0.28, 0.88, 1.0),
            emissiveColor: SIMD3(0.38, 0.24, 0.85),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.30, 0.18, 0.65, 1.0),
            emissiveColor: SIMD3(0.26, 0.15, 0.60),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.18, 0.10, 0.42, 1.0),
            emissiveColor: SIMD3(0.15, 0.08, 0.38),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.08, 0.05, 0.20, 1.0),
            emissiveColor: SIMD3(0.06, 0.04, 0.16),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let rhodolite = ColorTheme(
        name: "Rhodolite",
        newborn: TierColors(
            baseColor: SIMD4(0.85, 0.30, 0.52, 1.0),
            emissiveColor: SIMD3(0.82, 0.26, 0.48),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.62, 0.18, 0.38, 1.0),
            emissiveColor: SIMD3(0.58, 0.15, 0.34),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.40, 0.10, 0.24, 1.0),
            emissiveColor: SIMD3(0.36, 0.08, 0.20),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.18, 0.05, 0.11, 1.0),
            emissiveColor: SIMD3(0.14, 0.04, 0.08),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let allThemes: [ColorTheme] = [.neon, .warmAmber, .oceanBlues, .aurora, .monochrome, .infrared, .bioluminescence, .sakura, .ember, .nebula, .glacier, .coral, .forest, .sunset, .twilight, .jade, .crimson, .amethyst, .copper, .gold, .midnight, .volcanic, .plasma, .frost, .arctic, .solar, .toxic, .starfield, .hologram, .cyberpunk, .vaporwave, .synthwave, .terracotta, .lavender, .matrix, .champagne, .opal, .roseGold, .peridot, .sapphire, .obsidian, .ruby, .titanium, .garnet, .emerald, .tungsten, .aquamarine, .bronze, .ivory, .pearl, .graphite, .slate, .cobalt, .vermilion, .indigo, .mahogany, .burgundy, .teal, .chartreuse, .saffron, .moss, .cerulean, .mauve, .marigold, .sage, .ochre, .umber, .sienna, .viridian, .pewter, .celadon, .turquoise, .denim, .apricot, .plum, .wisteria, .rosewood, .patina, .carnelian, .malachite, .alexandrite, .tanzanite, .citrine, .topaz, .fluorite, .sunstone, .rhodonite, .lapisLazuli, .zircon, .onyx, .tourmaline, .larimar, .jasper, .labradorite, .amazonite, .amber, .sodalite, .rhodochrosite, .kunzite, .spinel, .hematite, .chrysocolla, .moonstone, .chalcedony, .beryl, .azurite, .kyanite, .agate, .ammolite, .petrifiedWood, .pyrite, .chrysoprase, .charoite, .iolite, .rhodolite, .seraphinite, .aventurine, .prehnite, .tsavorite, .celestite, .dumortierite, .benitoite, .sugilite, .bloodstone, .dioptase, .moldavite, .variscite, .lepidolite, .aragonite, .unakite, .chrysoberyl, .andalusite, .sphalerite, .staurolite, .grandidierite, .strontianite, .wulfenite, .vivianite, .pietersite, .piemontite, .scapolite, .epidote, .smithsonite, .zoisite, .kornerupine, .cassiterite, .hemimorphite, .hackmanite, .sphene, .crocoite, .ametrine, .bornite, .painite, .danburite]

    static let seraphinite = ColorTheme(
        name: "Seraphinite",
        newborn: TierColors(
            baseColor: SIMD4(0.32, 0.62, 0.38, 1.0),
            emissiveColor: SIMD3(0.28, 0.58, 0.34),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.20, 0.44, 0.26, 1.0),
            emissiveColor: SIMD3(0.16, 0.40, 0.22),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.10, 0.28, 0.14, 1.0),
            emissiveColor: SIMD3(0.08, 0.24, 0.10),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.05, 0.14, 0.07, 1.0),
            emissiveColor: SIMD3(0.04, 0.10, 0.05),
            emissiveIntensity: 0.4, opacity: 0.10)
    )
    ...
    static let aventurine = ColorTheme(
        name: "Aventurine",
        newborn: TierColors(
            baseColor: SIMD4(0.42, 0.78, 0.38, 1.0),
            emissiveColor: SIMD3(0.38, 0.74, 0.34),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.32, 0.58, 0.28, 1.0),
            emissiveColor: SIMD3(0.28, 0.54, 0.24),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.20, 0.38, 0.16, 1.0),
            emissiveColor: SIMD3(0.16, 0.34, 0.12),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.10, 0.20, 0.08, 1.0),
    ...
    static let tsavorite = ColorTheme(
        name: "Tsavorite",
        newborn: TierColors(
            baseColor: SIMD4(0.18, 0.90, 0.42, 1.0),
            emissiveColor: SIMD3(0.14, 0.85, 0.38),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.10, 0.65, 0.30, 1.0),
            emissiveColor: SIMD3(0.08, 0.60, 0.26),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.05, 0.40, 0.18, 1.0),
            emissiveColor: SIMD3(0.04, 0.36, 0.14),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.02, 0.20, 0.09, 1.0),
            emissiveColor: SIMD3(0.02, 0.16, 0.07),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let dumortierite = ColorTheme(
        name: "Dumortierite",
        newborn: TierColors(
            baseColor: SIMD4(0.28, 0.32, 0.82, 1.0),
            emissiveColor: SIMD3(0.24, 0.28, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.18, 0.22, 0.62, 1.0),
            emissiveColor: SIMD3(0.14, 0.18, 0.58),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.10, 0.14, 0.40, 1.0),
            emissiveColor: SIMD3(0.08, 0.10, 0.36),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.05, 0.07, 0.20, 1.0),
    ...
    static let benitoite = ColorTheme(
        name: "Benitoite",
        newborn: TierColors(
            baseColor: SIMD4(0.20, 0.35, 0.92, 1.0),
            emissiveColor: SIMD3(0.16, 0.30, 0.88),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.12, 0.22, 0.70, 1.0),
            emissiveColor: SIMD3(0.10, 0.18, 0.65),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.06, 0.12, 0.45, 1.0),
            emissiveColor: SIMD3(0.05, 0.10, 0.40),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.03, 0.06, 0.22, 1.0),
            emissiveColor: SIMD3(0.02, 0.05, 0.18),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let sugilite = ColorTheme(
        name: "Sugilite",
        newborn: TierColors(
            baseColor: SIMD4(0.68, 0.22, 0.82, 1.0),
            emissiveColor: SIMD3(0.62, 0.18, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.48, 0.14, 0.62, 1.0),
            emissiveColor: SIMD3(0.42, 0.10, 0.58),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.30, 0.08, 0.42, 1.0),
            emissiveColor: SIMD3(0.25, 0.06, 0.38),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.15, 0.04, 0.22, 1.0),
            emissiveColor: SIMD3(0.12, 0.03, 0.18),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let dioptase = ColorTheme(
        name: "Dioptase",
        newborn: TierColors(
            baseColor: SIMD4(0.08, 0.88, 0.58, 1.0),
            emissiveColor: SIMD3(0.06, 0.84, 0.54),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.05, 0.62, 0.42, 1.0),
            emissiveColor: SIMD3(0.04, 0.58, 0.38),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.03, 0.38, 0.26, 1.0),
            emissiveColor: SIMD3(0.02, 0.34, 0.22),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.02, 0.18, 0.12, 1.0),
            emissiveColor: SIMD3(0.01, 0.14, 0.10),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let bloodstone = ColorTheme(
        name: "Bloodstone",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.18, 0.15, 1.0),
            emissiveColor: SIMD3(0.68, 0.14, 0.12),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.22, 0.52, 0.28, 1.0),
            emissiveColor: SIMD3(0.18, 0.48, 0.24),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.12, 0.32, 0.16, 1.0),
            emissiveColor: SIMD3(0.10, 0.28, 0.13),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.06, 0.16, 0.08, 1.0),
            emissiveColor: SIMD3(0.04, 0.12, 0.06),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let moldavite = ColorTheme(
        name: "Moldavite",
        newborn: TierColors(
            baseColor: SIMD4(0.42, 0.72, 0.28, 1.0),
            emissiveColor: SIMD3(0.38, 0.68, 0.24),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.28, 0.52, 0.18, 1.0),
            emissiveColor: SIMD3(0.24, 0.48, 0.15),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.16, 0.32, 0.10, 1.0),
            emissiveColor: SIMD3(0.13, 0.28, 0.08),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.08, 0.16, 0.05, 1.0),
            emissiveColor: SIMD3(0.06, 0.12, 0.04),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let variscite = ColorTheme(
        name: "Variscite",
        newborn: TierColors(
            baseColor: SIMD4(0.58, 0.82, 0.52, 1.0),
            emissiveColor: SIMD3(0.54, 0.78, 0.48),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.40, 0.62, 0.36, 1.0),
            emissiveColor: SIMD3(0.36, 0.58, 0.32),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.24, 0.42, 0.22, 1.0),
            emissiveColor: SIMD3(0.20, 0.38, 0.18),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.12, 0.22, 0.10, 1.0),
            emissiveColor: SIMD3(0.08, 0.18, 0.06),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let lepidolite = ColorTheme(
        name: "Lepidolite",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.52, 0.82, 1.0),
            emissiveColor: SIMD3(0.68, 0.48, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.52, 0.35, 0.62, 1.0),
            emissiveColor: SIMD3(0.48, 0.32, 0.58),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.34, 0.22, 0.42, 1.0),
            emissiveColor: SIMD3(0.30, 0.18, 0.38),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.18, 0.12, 0.22, 1.0),
            emissiveColor: SIMD3(0.14, 0.08, 0.18),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let aragonite = ColorTheme(
        name: "Aragonite",
        newborn: TierColors(
            baseColor: SIMD4(0.92, 0.68, 0.32, 1.0),
            emissiveColor: SIMD3(0.88, 0.64, 0.28),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.72, 0.48, 0.22, 1.0),
            emissiveColor: SIMD3(0.68, 0.44, 0.18),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.48, 0.30, 0.14, 1.0),
            emissiveColor: SIMD3(0.44, 0.26, 0.10),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.24, 0.15, 0.07, 1.0),
            emissiveColor: SIMD3(0.20, 0.12, 0.05),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let unakite = ColorTheme(
        name: "Unakite",
        newborn: TierColors(
            baseColor: SIMD4(0.82, 0.48, 0.52, 1.0),
            emissiveColor: SIMD3(0.78, 0.44, 0.48),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.52, 0.68, 0.42, 1.0),
            emissiveColor: SIMD3(0.48, 0.64, 0.38),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.35, 0.48, 0.30, 1.0),
            emissiveColor: SIMD3(0.32, 0.44, 0.26),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.20, 0.28, 0.16, 1.0),
            emissiveColor: SIMD3(0.16, 0.24, 0.12),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let chrysoberyl = ColorTheme(
        name: "Chrysoberyl",
        newborn: TierColors(
            baseColor: SIMD4(0.92, 0.85, 0.28, 1.0),
            emissiveColor: SIMD3(0.88, 0.80, 0.24),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.72, 0.65, 0.18, 1.0),
            emissiveColor: SIMD3(0.68, 0.60, 0.14),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.50, 0.44, 0.10, 1.0),
            emissiveColor: SIMD3(0.46, 0.40, 0.08),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.25, 0.22, 0.05, 1.0),
            emissiveColor: SIMD3(0.22, 0.18, 0.04),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let andalusite = ColorTheme(
        name: "Andalusite",
        newborn: TierColors(
            baseColor: SIMD4(0.78, 0.48, 0.42, 1.0),
            emissiveColor: SIMD3(0.74, 0.44, 0.38),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.58, 0.35, 0.30, 1.0),
            emissiveColor: SIMD3(0.54, 0.31, 0.26),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.40, 0.24, 0.20, 1.0),
            emissiveColor: SIMD3(0.36, 0.20, 0.16),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.20, 0.12, 0.10, 1.0),
            emissiveColor: SIMD3(0.16, 0.08, 0.06),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let sphalerite = ColorTheme(
        name: "Sphalerite",
        newborn: TierColors(
            baseColor: SIMD4(0.88, 0.72, 0.30, 1.0),
            emissiveColor: SIMD3(0.84, 0.68, 0.26),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.68, 0.50, 0.20, 1.0),
            emissiveColor: SIMD3(0.64, 0.46, 0.16),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.46, 0.32, 0.12, 1.0),
            emissiveColor: SIMD3(0.42, 0.28, 0.08),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.23, 0.16, 0.06, 1.0),
            emissiveColor: SIMD3(0.19, 0.12, 0.04),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let staurolite = ColorTheme(
        name: "Staurolite",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.48, 0.28, 1.0),
            emissiveColor: SIMD3(0.68, 0.44, 0.24),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.52, 0.34, 0.18, 1.0),
            emissiveColor: SIMD3(0.48, 0.30, 0.14),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.34, 0.22, 0.12, 1.0),
            emissiveColor: SIMD3(0.30, 0.18, 0.08),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.17, 0.11, 0.06, 1.0),
            emissiveColor: SIMD3(0.13, 0.07, 0.03),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let grandidierite = ColorTheme(
        name: "Grandidierite",
        newborn: TierColors(
            baseColor: SIMD4(0.22, 0.78, 0.72, 1.0),
            emissiveColor: SIMD3(0.18, 0.74, 0.68),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.14, 0.58, 0.52, 1.0),
            emissiveColor: SIMD3(0.10, 0.54, 0.48),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.08, 0.38, 0.34, 1.0),
            emissiveColor: SIMD3(0.06, 0.34, 0.30),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.04, 0.20, 0.18, 1.0),
            emissiveColor: SIMD3(0.03, 0.16, 0.14),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let strontianite = ColorTheme(
        name: "Strontianite",
        newborn: TierColors(
            baseColor: SIMD4(0.90, 0.92, 0.65, 1.0),
            emissiveColor: SIMD3(0.86, 0.88, 0.60),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.70, 0.72, 0.45, 1.0),
            emissiveColor: SIMD3(0.66, 0.68, 0.40),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.48, 0.50, 0.28, 1.0),
            emissiveColor: SIMD3(0.44, 0.46, 0.24),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.24, 0.25, 0.14, 1.0),
            emissiveColor: SIMD3(0.20, 0.21, 0.10),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let wulfenite = ColorTheme(
        name: "Wulfenite",
        newborn: TierColors(
            baseColor: SIMD4(0.95, 0.62, 0.12, 1.0),
            emissiveColor: SIMD3(0.92, 0.58, 0.08),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.82, 0.44, 0.08, 1.0),
            emissiveColor: SIMD3(0.78, 0.40, 0.05),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.62, 0.28, 0.05, 1.0),
            emissiveColor: SIMD3(0.58, 0.24, 0.03),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.32, 0.14, 0.03, 1.0),
            emissiveColor: SIMD3(0.28, 0.10, 0.02),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let vivianite = ColorTheme(
        name: "Vivianite",
        newborn: TierColors(
            baseColor: SIMD4(0.12, 0.48, 0.72, 1.0),
            emissiveColor: SIMD3(0.08, 0.44, 0.68),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.08, 0.34, 0.55, 1.0),
            emissiveColor: SIMD3(0.04, 0.30, 0.50),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.04, 0.20, 0.38, 1.0),
            emissiveColor: SIMD3(0.02, 0.16, 0.34),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.02, 0.10, 0.19, 1.0),
            emissiveColor: SIMD3(0.01, 0.06, 0.15),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let piemontite = ColorTheme(
        name: "Piemontite",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.28, 0.42, 1.0),
            emissiveColor: SIMD3(0.68, 0.24, 0.38),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.52, 0.18, 0.32, 1.0),
            emissiveColor: SIMD3(0.48, 0.14, 0.28),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.34, 0.10, 0.22, 1.0),
            emissiveColor: SIMD3(0.30, 0.08, 0.18),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.17, 0.05, 0.11, 1.0),
            emissiveColor: SIMD3(0.13, 0.04, 0.08),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let scapolite = ColorTheme(
        name: "Scapolite",
        newborn: TierColors(
            baseColor: SIMD4(0.88, 0.82, 0.48, 1.0),
            emissiveColor: SIMD3(0.84, 0.78, 0.44),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.68, 0.60, 0.34, 1.0),
            emissiveColor: SIMD3(0.64, 0.56, 0.30),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.48, 0.42, 0.22, 1.0),
            emissiveColor: SIMD3(0.44, 0.38, 0.18),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.26, 0.22, 0.12, 1.0),
            emissiveColor: SIMD3(0.22, 0.18, 0.10),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let epidote = ColorTheme(
        name: "Epidote",
        newborn: TierColors(
            baseColor: SIMD4(0.58, 0.72, 0.28, 1.0),
            emissiveColor: SIMD3(0.54, 0.68, 0.24),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.40, 0.54, 0.18, 1.0),
            emissiveColor: SIMD3(0.36, 0.50, 0.14),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.26, 0.38, 0.10, 1.0),
            emissiveColor: SIMD3(0.22, 0.34, 0.08),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.14, 0.20, 0.06, 1.0),
            emissiveColor: SIMD3(0.10, 0.16, 0.04),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let smithsonite = ColorTheme(
        name: "Smithsonite",
        newborn: TierColors(
            baseColor: SIMD4(0.55, 0.82, 0.85, 1.0),
            emissiveColor: SIMD3(0.50, 0.78, 0.82),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.38, 0.62, 0.68, 1.0),
            emissiveColor: SIMD3(0.34, 0.58, 0.64),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.22, 0.42, 0.48, 1.0),
            emissiveColor: SIMD3(0.18, 0.38, 0.44),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.11, 0.21, 0.24, 1.0),
            emissiveColor: SIMD3(0.08, 0.17, 0.20),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let zoisite = ColorTheme(
        name: "Zoisite",
        newborn: TierColors(
            baseColor: SIMD4(0.48, 0.32, 0.72, 1.0),
            emissiveColor: SIMD3(0.44, 0.28, 0.68),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.35, 0.22, 0.55, 1.0),
            emissiveColor: SIMD3(0.31, 0.18, 0.51),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.24, 0.14, 0.40, 1.0),
            emissiveColor: SIMD3(0.20, 0.10, 0.36),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.12, 0.07, 0.20, 1.0),
            emissiveColor: SIMD3(0.08, 0.04, 0.16),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let kornerupine = ColorTheme(
        name: "Kornerupine",
        newborn: TierColors(
            baseColor: SIMD4(0.52, 0.68, 0.35, 1.0),
            emissiveColor: SIMD3(0.48, 0.64, 0.32),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.38, 0.52, 0.25, 1.0),
            emissiveColor: SIMD3(0.34, 0.48, 0.22),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.25, 0.38, 0.16, 1.0),
            emissiveColor: SIMD3(0.22, 0.34, 0.14),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.14, 0.22, 0.09, 1.0),
            emissiveColor: SIMD3(0.11, 0.18, 0.07),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let cassiterite = ColorTheme(
        name: "Cassiterite",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.52, 0.28, 1.0),
            emissiveColor: SIMD3(0.68, 0.48, 0.24),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.52, 0.36, 0.18, 1.0),
            emissiveColor: SIMD3(0.48, 0.32, 0.14),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.32, 0.22, 0.10, 1.0),
            emissiveColor: SIMD3(0.28, 0.18, 0.08),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.16, 0.11, 0.05, 1.0),
            emissiveColor: SIMD3(0.12, 0.08, 0.03),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let hemimorphite = ColorTheme(
        name: "Hemimorphite",
        newborn: TierColors(
            baseColor: SIMD4(0.62, 0.85, 0.92, 1.0),
            emissiveColor: SIMD3(0.58, 0.82, 0.88),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.42, 0.65, 0.75, 1.0),
            emissiveColor: SIMD3(0.38, 0.62, 0.72),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.25, 0.45, 0.55, 1.0),
            emissiveColor: SIMD3(0.22, 0.42, 0.52),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.12, 0.22, 0.28, 1.0),
            emissiveColor: SIMD3(0.09, 0.18, 0.24),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let hackmanite = ColorTheme(
        name: "Hackmanite",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.38, 0.78, 1.0),
            emissiveColor: SIMD3(0.68, 0.34, 0.74),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.55, 0.28, 0.62, 1.0),
            emissiveColor: SIMD3(0.51, 0.24, 0.58),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.40, 0.18, 0.46, 1.0),
            emissiveColor: SIMD3(0.36, 0.14, 0.42),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.22, 0.10, 0.26, 1.0),
            emissiveColor: SIMD3(0.18, 0.07, 0.22),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    // Crocoite — vivid orange-red lead chromate (PbCrO₄)
    // Named from Greek "krokos" (saffron) for its intense color
    // Found primarily in Tasmania, prized for elongated prismatic crystals
    static let crocoite = ColorTheme(
        name: "Crocoite",
        newborn: TierColors(
            baseColor: SIMD4(0.95, 0.42, 0.08, 1.0),
            emissiveColor: SIMD3(0.92, 0.38, 0.06),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.78, 0.30, 0.05, 1.0),
            emissiveColor: SIMD3(0.74, 0.26, 0.04),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.58, 0.20, 0.03, 1.0),
            emissiveColor: SIMD3(0.54, 0.17, 0.02),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.35, 0.12, 0.02, 1.0),
            emissiveColor: SIMD3(0.31, 0.09, 0.01),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    // Sphene (titanite) — vivid yellow-green calcium titanium silicate (CaTiSiO₅)
    // Known for exceptional fire (dispersion higher than diamond at 0.051)
    // Named from Greek "sphenos" (wedge) for its wedge-shaped crystals
    static let sphene = ColorTheme(
        name: "Sphene",
        newborn: TierColors(
            baseColor: SIMD4(0.78, 0.82, 0.22, 1.0),
            emissiveColor: SIMD3(0.74, 0.78, 0.18),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.58, 0.62, 0.15, 1.0),
            emissiveColor: SIMD3(0.54, 0.58, 0.12),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.40, 0.44, 0.10, 1.0),
            emissiveColor: SIMD3(0.36, 0.40, 0.08),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.22, 0.25, 0.06, 1.0),
            emissiveColor: SIMD3(0.18, 0.21, 0.04),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    static let ametrine = ColorTheme(
        name: "Ametrine",
        newborn: TierColors(
            baseColor: SIMD4(0.72, 0.42, 0.82, 1.0),
            emissiveColor: SIMD3(0.68, 0.38, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.75, 0.62, 0.28, 1.0),
            emissiveColor: SIMD3(0.70, 0.58, 0.24),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.52, 0.32, 0.58, 1.0),
            emissiveColor: SIMD3(0.48, 0.28, 0.54),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.28, 0.18, 0.32, 1.0),
            emissiveColor: SIMD3(0.24, 0.14, 0.28),
            emissiveIntensity: 0.4, opacity: 0.10)
    )

    // Bornite ("peacock ore") — iridescent copper iron sulfide (Cu₅FeS₄)
    // Vivid purple-blue newborn → bronze-gold young → deep indigo mature → dark charcoal dying
    static let bornite = ColorTheme(
        name: "Bornite",
        newborn: TierColors(
            baseColor: SIMD4(0.58, 0.32, 0.82, 1.0),
            emissiveColor: SIMD3(0.54, 0.28, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.72, 0.58, 0.28, 1.0),
            emissiveColor: SIMD3(0.68, 0.54, 0.24),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.22, 0.18, 0.48, 1.0),
            emissiveColor: SIMD3(0.18, 0.14, 0.44),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
    ...
    static let danburite = ColorTheme(
        name: "Danburite",
        newborn: TierColors(
            baseColor: SIMD4(0.95, 0.90, 0.72, 1.0),
            emissiveColor: SIMD3(0.92, 0.86, 0.68),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.82, 0.76, 0.58, 1.0),
            emissiveColor: SIMD3(0.78, 0.72, 0.54),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.62, 0.56, 0.42, 1.0),
            emissiveColor: SIMD3(0.58, 0.52, 0.38),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.38, 0.34, 0.25, 1.0),
            emissiveColor: SIMD3(0.34, 0.30, 0.21),
            emissiveIntensity: 0.4, opacity: 0.10)
    )
}
