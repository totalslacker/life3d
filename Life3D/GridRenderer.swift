...
struct ColorTheme: Sendable, Identifiable, Hashable {
    ...
    static let smithsonite = ColorTheme(
        name: "Smithsonite",
        newborn: TierColors(
            baseColor: SIMD4(0.52, 0.78, 0.82, 1.0),
            emissiveColor: SIMD3(0.48, 0.74, 0.78),
            emissiveIntensity: 2.0, opacity: 0.55),
        young: TierColors(
            baseColor: SIMD4(0.38, 0.58, 0.65, 1.0),
            emissiveColor: SIMD3(0.34, 0.54, 0.61),
            emissiveIntensity: 1.2, opacity: 0.35),
        mature: TierColors(
            baseColor: SIMD4(0.25, 0.40, 0.48, 1.0),
            emissiveColor: SIMD3(0.21, 0.36, 0.44),
            emissiveIntensity: 0.7, opacity: 0.25),
        dying: TierColors(
            baseColor: SIMD4(0.12, 0.20, 0.24, 1.0),
            emissiveColor: SIMD3(0.08, 0.16, 0.20),
            emissiveIntensity: 0.4, opacity: 0.10)
    )
}
