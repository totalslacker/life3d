...
struct ForestThemeTests {
    ...
    func themeCount() {
        #expect(ColorTheme.allThemes.count == 122)
    }
...
struct AliveMapResetRegressionTests {
    ...
    func patternCount() {
        ...
        #expect(allPatterns.count == 118)
        let cyclable = allPatterns.filter { $0 != .clear }
        #expect(cyclable.count == 117)
    }
}
...
struct PietersiteThemeTests {
    ...
    @Test func pietersiteInAllThemes() {
        ...
        #expect(ColorTheme.allThemes.count == 120)
    }
}
