...
struct FoliumOfDescartesPatternTests {
    ...
    @Test func foliumOfDescartesHasSubstantialCells() {
        var grid = GridModel(size: 16)
        grid.loadFoliumOfDescartes()
        #expect(grid.aliveCount > 50)
    }
    @Test func foliumOfDescartesNotFullGrid() {
        var grid = GridModel(size: 16)
        grid.loadFoliumOfDescartes()
        #expect(grid.aliveCount < 16 * 16 * 16)
    }
    @Test func foliumOfDescartesReproducible() {
        var gridA = GridModel(size: 16)
    ...
    @Test func foliumOfDescartesScalesWithGridSize() {
        var small = GridModel(size: 12)
        small.loadFoliumOfDescartes()
        var large = GridModel(size: 24)
        large.loadFoliumOfDescartes()
        #expect(large.aliveCount > small.aliveCount)
    }
    ...
    @Test func foliumOfDescartesDistinctFromCardioid() {
        var gridA = GridModel(size: 16)
        gridA.loadFoliumOfDescartes()
        var gridB = GridModel(size: 16)
        gridB.loadCardioid()
...
struct SmithsoniteThemeTests {
    ...
    @Test func smithsoniteThemeBlueGreenDominant() {
        let theme = ColorTheme.smithsonite
        // B > G > R for blue-green
    ...
    @Test func smithsoniteDistinctFromAquamarine() {
        let smithsonite = ColorTheme.smithsonite
        let aquamarine = ColorTheme.aquamarine
        let rDiff = abs(smithsonite.newborn.baseColor.x - aquamarine.newborn.baseColor.x)
        let gDiff = abs(smithsonite.newborn.baseColor.y - aquamarine.newborn.baseColor.y)
        let bDiff = abs(smithsonite.newborn.baseColor.z - aquamarine.newborn.baseColor.z)
        #expect(rDiff + gDiff + bDiff > 0.05)
    }
}
