...
- [x] Preset patterns: 3D gliders, oscillators, still lifes, random seed, diamond, cross, tube, sphere, mirror symmetry, stagger lattice, helix, rings, spiral, torus (session 34, 45, 47, 48, 49, 52, 54)
...
- [x] Color themes: neon on black, warm amber, ocean blues, aurora borealis, ember, coral, forest, sunset, jade, crimson, amethyst, copper (19 total)
