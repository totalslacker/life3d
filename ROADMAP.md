...
- [x] Preset patterns: 3D gliders, oscillators, still lifes, random seed, diamond, cross, tube, sphere, mirror symmetry, stagger lattice, helix, rings, spiral, torus, galaxy, pyramid, wave, lattice, checkerboard, Menger sponge, cage, trefoil knot (session 34, 45, 47, 48, 49, 52, 54, 55, 56, 57, 58, 59)
